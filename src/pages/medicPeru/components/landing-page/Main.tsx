    ...
    <main>
        ...
        <div className="flex justify-between items-center">
          <div className="md:w-1/2 md:ml-0 ml-7">
            <div className="md:ml-16">
              <div className="bg-green-300 xl:w-52 md:w-32 w-16 md:h-3 h-2 xl:mb-10 md:mb-7 mb-5"></div>

              <div className="xl:text-5xl md:text-3xl text-xl montserrat-bold xl:w-auto">
                <h1>Un gran lugar para recibir atencion</h1>
              </div>

              <div className="xl:my-10 my-5 text-gray-700 montserrat-regular xl:text-xl md:text-base text-sm md:w-auto">
              ...
              <div className="flex items-center montserrat-bold text-red-400">
                <p className="bg-white hover:bg-slate-100 md:text-xl mr-4">
                  Saber Mas
                </p>
                <svg
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="md:w-1/2 md:mr-0 mr-7">
            <div className="md:mr-16">
              <div className="bg-green-300 xl:w-52 md:w-32 w-16 md:h-3 h-2 xl:mb-10 md:mb-7 mb-5 ml-auto"></div>

              <div className="xl:text-5xl md:text-3xl text-xl montserrat-bold xl:w-auto flex flex-col text-end">
                <h1>Un gran lugar para recibir atencion</h1>
              </div>

              <div className="xl:my-10 my-5 text-gray-700 montserrat-regular xl:text-lg md:text-base text-sm flex flex-col text-end">
                <h2 className="xl:whitespace-normal md:whitespace-normal">
              ...
              <div className="flex justify-end items-center montserrat-bold text-red-400">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                ...
                <p className="bg-white hover:bg-slate-100 ml-4 md:text-xl">
                  Saber Mas
                </p>
              </div>
            </div>
      ...
      <section className="bg-sky-200 xl:py-32 md:py-14 xl:pt-28 md:pt-20 mt-16">
        <div className="xl:mx-40 md:ml-10 mx-7 py-16 md:py-0 pb-0">
          <h2 className="md:text-5xl text-4xl montserrat-bold">
            Nuestros Servicios
          </h2>
        ...
        <div className="flex flex-wrap justify-center mt-10">
          <div className="p-4 max-w-sm">
            <div className="flex rounded-lg h-full bg-white p-8 flex-col">
              <div>
                <img src={Logo} alt="logo-imagen" className="h-auto mx-auto" />
              </div>
              ...
              <div className="mx-2">
                ...
                <div>
                  ...
                  <div className="mt-6 mb-8">
                    <button className="btn w-48 bg-white hover:bg-slate-100 border-red-400 hover:border-red-400 border-2 text-red-400">
                      Saber Mas
                    </button>
                  </div>
                </div>
